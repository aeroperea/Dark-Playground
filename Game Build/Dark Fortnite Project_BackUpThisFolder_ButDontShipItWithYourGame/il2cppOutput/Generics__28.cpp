...
IL_001e:
	{
		int32_t L_9 = V_0;
		int32_t L_10;
		L_10 = DynamicArray_1_get_size_m50BE45B1D6E4F5AB585057618FDF05DA0A980DEB_inline(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 4));
		if ((((int32_t)L_9) < ((int32_t)L_10)))
		{
			goto IL_0004;
		}
...
{
	{
		CachedSkyContext_tA2295FEDB4BABCF87E7A490494D1727C9D5297FB L_0 = ___0_item;
		int32_t L_1;
		L_1 = DynamicArray_1_IndexOf_m2D0B40762235C5D927B64EB18C2957D94978A3DB(__this, L_0, 0, il2cpp_rgctx_method(method->klass->rgctx_data, 17));
		return L_1;
	}
}
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void DynamicArray_1_Resize_mA7E76173DF4DD7A892CB8A85F5C75DABEBE0F619_gshared (DynamicArray_1_t1FC202F943EA09877FD66BE584C233186471614B* __this, int32_t ___0_newSize, bool ___1_keepContent, const RuntimeMethod* method) 
...
{
	{
		...
		memset((&L_4), 0, sizeof(L_4));
		ReadOnlySpan_1__ctor_m3C349A1D843E1878A78550B370BE200ED12BBB9A_inline((&L_4), L_1, 0, L_3, il2cpp_rgctx_method(InitializedTypeInfo(method->klass)->rgctx_data, 19));
		return L_4;
	}
}
...
{
	{
		...
		memset((&L_4), 0, sizeof(L_4));
		Span_1__ctor_m19E90A7DE620222C7BA637F4922497BFF6497754_inline((&L_4), L_1, 0, L_3, il2cpp_rgctx_method(InitializedTypeInfo(method->klass)->rgctx_data, 21));
		return L_4;
	}
}
...
{
	{
		...
		memset((&L_0), 0, sizeof(L_0));
		Iterator__ctor_mD455C090A3280F335CC4952295AFC5A47CB2C1D6((&L_0), __this, il2cpp_rgctx_method(method->klass->rgctx_data, 23));
		return L_0;
	}
}
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RangeEnumerable_tECD4A19782762FA88974FF4FE07DB956374C6FB7 DynamicArray_1_SubRange_mC090C285855749E487BD07CF8034E5A129CF78D1_gshared (DynamicArray_1_t1FC202F943EA09877FD66BE584C233186471614B* __this, int32_t ___0_first, int32_t ___1_numItems, const RuntimeMethod* method) 
{
	...
	memset((&V_0), 0, sizeof(V_0));
	{
		...
		memset((&L_2), 0, sizeof(L_2));
		RangeIterator__ctor_m6A4D026958F7BA4E6A19D4236E093AA4F481483A((&L_2), __this, L_0, L_1, il2cpp_rgctx_method(method->klass->rgctx_data, 26));
		(&V_0)->___iterator = L_2;
		Il2CppCodeGenWriteBarrier((void**)&(((&(&V_0)->___iterator))->___owner), (void*)NULL);
